...
export const ANIMALS = [
  ...
  // ─── TIER S (Míticos) ───
  { id: 'onca-parda', name: 'Onça-parda', sci: 'Puma concolor', emoji: '🦁', img: 'https://upload.wikimedia.org/wikipedia/commons/d/d6/Mountain_Lion_in_Glacier_National_Park.jpg', tier: 'S', tierLabel: 'Mítico', pts: 450, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas extensas de mata', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Puma_concolor', danger: 'critico', habits: ['🥩 Carnívoro', '🌙 Noturno', '🗺️ Territorial'], howToFind: 'Áreas extensas de mata; extremamente arredio — se ver, afaste-se devagar' },
  { id: 'jaguatirica', name: 'Jaguatirica', sci: 'Leopardus pardalis', emoji: '🐱', img: 'https://upload.wikimedia.org/wikipedia/commons/b/b5/081_Ocelot_in_Encontro_das_%C3%81guas_State_Park_Photo_by_Giles_Laurent.jpg', tier: 'S', tierLabel: 'Mítico', pts: 350, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas e capoeiras', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Jaguatirica', danger: 'alto', habits: ['🥩 Carnívoro', '🌙 Noturno', '🤺 Solitário'], howToFind: 'Áreas de mata fechada; raramente vista, mais ativa à noite' },
  { id: 'ariranha', name: 'Ariranha', sci: 'Pteronura brasiliensis', emoji: '🦦', img: 'https://upload.wikimedia.org/wikipedia/commons/0/09/Giant_Otter_area.png', tier: 'S', tierLabel: 'Mítico', pts: 500, status: 'EN', statusLabel: 'Em Perigo', where: 'Rios e lagoas de águas claras', habitat: 'Aquático', wiki: 'https://pt.wikipedia.org/wiki/Ariranha', danger: 'medio', habits: ['🐟 Piscívora', '🌊 Aquática', '👨‍👩‍👧‍👧 Grupos familiares'], howToFind: 'Rios preservados; vista em grupos — não se aproxime dos filhotes' },
  { id: 'anta', name: 'Anta', sci: 'Tapirus terrestris', emoji: '🫏', img: 'https://upload.wikimedia.org/wikipedia/commons/3/36/South_American_tapir_%28Tapirus_terrestris%29.JPG', tier: 'S', tierLabel: 'Mítico', pts: 400, status: 'VU', statusLabel: 'Vulnerável', where: 'Próximo a rios e brejos', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Anta', danger: 'alto', habits: ['🥜 Herbívoro', '🌙 Noturno', '💧 Ribeirinho'], howToFind: 'Margens de rios e brejos; pode ser agressiva se encurralada' },
  { id: 'veado-campeiro', name: 'Veado-campeiro', sci: 'Ozotoceros bezoarticus', emoji: '🦌', img: 'https://upload.wikimedia.org/wikipedia/commons/b/b8/O._bezoarticus_buck.jpg', tier: 'S', tierLabel: 'Mítico', pts: 280, status: 'NT', statusLabel: 'Quase ameaçado', where: 'Campos abertos e cerrado', habitat: 'Cerrado/Campo', wiki: 'https://pt.wikipedia.org/wiki/Veado-campeiro', danger: 'baixo', habits: ['🌿 Herbívoro', '☀️ Diurno', '👨‍👩‍👧‍👧 Grupos'], howToFind: 'Campos abertos ao amanhecer; foge rapidamente ao menor sinal' },
  ...
  { id: 'gaviao', name: 'Gavião-carijó', sci: 'Rupornis magnirostris', emoji: '🦅', img: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Buteo_magnirostris_-Goias_-Brazil-8.jpg', tier: 'B', tierLabel: 'Raro', pts: 90, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas abertas e bordas', habitat: 'Floresta/Campo', wiki: 'https://pt.wikipedia.org/wiki/Gavi%C3%A3o-carij%C3%B3', danger: 'alto', habits: ['🥩 Carnívoro', '☀️ Diurno', '🌳 Poleiros'], howToFind: 'Observe poleiros altos em bordas de mata; seus chamados denunciam' },
  ...
  { id: 'joao-de-barro', name: 'João-de-barro', sci: 'Furnarius rufus', emoji: '🐦', img: 'https://upload.wikimedia.org/wikipedia/commons/4/40/Rufous_Hornero_%28Furnarius_rufus%29.jpg', tier: 'C', tierLabel: 'Comum', pts: 28, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e postes', habitat: 'Campo/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Jo%C3%A3o-de-barro', danger: 'inofensivo', habits: ['🏗️ Construtor', '🧱 Ninho de barro', '☀️ Diurno'], howToFind: 'Postes e árvores isoladas; procure o ninho de barro característico' },
  ...
  { id: 'abelha', name: 'Abelha-europeia', sci: 'Apis mellifera', emoji: '🐝', img: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Apis_mellifera_-_Brassica_napus_-_Valingu.jpg', tier: 'C', tierLabel: 'Comum', pts: 18, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Jardins e campos floridos', habitat: 'Campo/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Abelha-europeia', danger: 'medio', habits: ['🌸 Polinizadora', '🍯 Produtora de mel', '👷‍♀️ Colmeia'], howToFind: 'Jardins e campos floridos; não perturbe a colmeia' },
  { id: 'ra', name: 'Rã-manteiga', sci: 'Leptodactylus ocellatus', emoji: '🐸', img: 'https://upload.wikimedia.org/wikipedia/commons/b/bd/Leptodactylus_labyrinthicus.jpg', tier: 'C', tierLabel: 'Comum', pts: 22, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Brejos e poças', habitat: 'Brejo/Rio', wiki: 'https://pt.wikipedia.org/wiki/R%C3%A3-manteiga', danger: 'inofensivo', habits: ['🐜 Insetívoro', '🌙 Noturno', '💧 Brejo'], howToFind: 'Brejos e poças; siga o coaxar noturno' },

  // ─── TIER D (Muito Comuns) ───
  { id: 'bem-te-vi', name: 'Bem-te-vi', sci: 'Pitangus sulphuratus', emoji: '🐦', img: 'https://upload.wikimedia.org/wikipedia/commons/9/94/Great_kiskadee_%2870240%29.jpg', tier: 'D', tierLabel: 'Muito Comum', pts: 12, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas abertas e urbanas', habitat: 'Urbano/Campo', wiki: 'https://pt.wikipedia.org/wiki/Bem-te-vi', danger: 'inofensivo', habits: ['🥩 Onívoro', '🎵 Canto', '🏘️ Urbano'], howToFind: 'Áreas abertas e urbanas; reconhecível pelo canto' },
  ...
  { id: 'formiga-sauva', name: 'Formiga-saúva', sci: 'Atta sexdens', emoji: '🐜', img: 'https://upload.wikimedia.org/wikipedia/commons/4/48/LeafAnt.jpg', tier: 'D', tierLabel: 'Muito Comum', pts: 8, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Formigueiros no chão', habitat: 'Solo', wiki: 'https://pt.wikipedia.org/wiki/Formiga-cortadeira', danger: 'inofensivo', habits: ['🌿 Cortadeira', '👷‍♀️ Colônia', '🌳 Subterrânea'], howToFind: 'Trilhas de formigas carregando folhas no chão' },
  { id: 'mosquito', name: 'Mosquito-pernilongo', sci: 'Culex quinquefasciatus', emoji: '🦟', img: 'https://upload.wikimedia.org/wikipedia/commons/d/d7/CulexNil.jpg', tier: 'D', tierLabel: 'Muito Comum', pts: 5, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas úmidas e urbanas', habitat: 'Urbano/Brejo', wiki: 'https://pt.wikipedia.org/wiki/Culex_quinquefasciatus', danger: 'medio', habits: ['🩸 Hematófago', '🌙 Noturno', '💧 Água parada'], howToFind: 'Áreas úmidas ao anoitecer; mais ativo à noite' },
