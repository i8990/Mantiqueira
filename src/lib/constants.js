...
export const ANIMALS = [
  // ─── TIER L (Lendários) ───
  { id: 'sapo-flamenguinho', name: 'Sapo-Flamenguinho', sci: 'Mascote', emoji: '🐸', img: 'https://upload.wikimedia.org/wikipedia/commons/5/55/Bufotes_balearicus_female.jpg', tier: 'L', tierLabel: 'Lendário', pts: 900, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Noites chuvosas em locais específicos', habitat: 'Místico', wiki: 'https://pt.wikipedia.org/wiki/Sapo', danger: 'inofensivo', habits: ['🐸 Mascote do app', '🌙 Noturno', '💧 Noites chuvosas'], howToFind: 'Apenas em noites chuvosas, em locais específicos. Taxa de encontro baixíssima.' },
