...
export const ANIMALS = [
  ...
  { id: 'bugio', name: 'Bugio', sci: 'Alouatta guariba', emoji: '🦍', img: 'https://upload.wikimedia.org/wikipedia/commons/1/1f/Brown_Howler_Monkey.jpg', tier: 'A', tierLabel: 'Épico', pts: 600, status: 'VU', statusLabel: 'Vulnerável', where: 'Dossel da mata', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Bugio', danger: 'alto', habits: ['🍉 Frugívoro', '🎵 Vocal', '👨‍👩‍👧‍👧 Grupos'], howToFind: 'Ouça o rugido característico ao amanhecer; não se aproxime' },
  { id: 'jacu', name: 'Jacu', sci: 'Penelope obscura', emoji: '🦃', tier: 'A', tierLabel: 'Épico', pts: 150, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Bordas de mata e capoeiras', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Jacu', danger: 'baixo', habits: ['🍉 Frugívoro', '🌳 Arborícola', '☀️ Diurno'], howToFind: 'Bordas de mata; vive em grupos pequenos' },
  { id: 'urutau', name: 'Urutau', sci: 'Nyctibius griseus', emoji: '🦉', img: 'https://upload.wikimedia.org/wikipedia/commons/f/fb/M%C3%A3e-da-lua-gigante_%28Nyctibius_grandis%29.jpg', tier: 'A', tierLabel: 'Épico', pts: 650, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Galhos secos e troncos', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Urutau', danger: 'inofensivo', habits: ['🌙 Noturno', '🪵 Camuflagem', '🎵 Canto lúgubre'], howToFind: 'Procure galhos secos e troncos; mestre da camuflagem' },
  ...
  { id: 'jaratataca', name: 'Jaratataca', sci: 'Conepatus semistriatus', emoji: '🦨', img: 'https://upload.wikimedia.org/wikipedia/commons/2/27/Conepatus_semistriatus.jpg', tier: 'A', tierLabel: 'Épico', pts: 400, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e bordas de mata', habitat: 'Cerrado/Campo', wiki: 'https://pt.wikipedia.org/wiki/Jaratataca', danger: 'medio', habits: ['🥩 Onívora', '🌙 Noturna', '💨 Exala mau cheiro'], howToFind: 'Campos abertos à noite; sente o cheiro antes de ver' },
  { id: 'caninana', name: 'Caninana', sci: 'Spilotes pullatus', emoji: '🐍', img: 'https://upload.wikimedia.org/wikipedia/commons/1/16/Caninana_%28Spilotes_pullatus%29_-_Foto_Antonio_Bordignon.jpg', tier: 'A', tierLabel: 'Épico', pts: 260, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas e áreas abertas', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Caninana', danger: 'alto', habits: ['🥩 Carnívora', '☀️ Diurna', '🌳 Arborícola'], howToFind: 'Árvores e solo; pode se irritar se provocada' },

  // ─── TIER B (Raros) ───
  { id: 'tucano', name: 'Tucano', sci: 'Ramphastos dicolorus', emoji: '🦅', img: 'https://upload.wikimedia.org/wikipedia/commons/d/de/Ramphastos_dicolorus_-S%C3%A3o_Paulo-SP%2C_Brasil-8.jpg', tier: 'B', tierLabel: 'Raro', pts: 100, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Dossel e bordas de mata', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Tucano-de-bico-verde', danger: 'baixo', habits: ['🍉 Frugívoro', '🌳 Dossel', '🎵 Vocal'], howToFind: 'Olhe para o alto nas bordas de mata; ouça o canto' },
  { id: 'mico', name: 'Mico', sci: 'Callithrix penicillata', emoji: '🐒', img: 'https://upload.wikimedia.org/wikipedia/commons/9/9d/Callithrix_penicillata_%28black-tufted_marmoset%29.jpg', tier: 'B', tierLabel: 'Raro', pts: 90, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas e capoeiras', habitat: 'Floresta/Cerrado', wiki: 'https://pt.wikipedia.org/wiki/Mico-estrela', danger: 'baixo', habits: ['🍉 Frugívoro', '🌳 Arborícola', '👨‍👩‍👧‍👧 Grupos'], howToFind: 'Copas de árvores em grupos; ativo durante o dia' },
  { id: 'gaviao', name: 'Gavião', sci: 'Rupornis magnirostris', emoji: '🦅', img: 'https://upload.wikimedia.org/wikipedia/commons/7/7e/Buteo_magnirostris_-Goias_-Brazil-8.jpg', tier: 'B', tierLabel: 'Raro', pts: 90, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas abertas e bordas', habitat: 'Floresta/Campo', wiki: 'https://pt.wikipedia.org/wiki/Gavi%C3%A3o-carij%C3%B3', danger: 'alto', habits: ['🥩 Carnívoro', '☀️ Diurno', '🌳 Poleiros'], howToFind: 'Observe poleiros altos em bordas de mata; seus chamados denunciam' },
  ...
  { id: 'teiu', name: 'Teiú', sci: 'Salvator merianae', emoji: '🦎', img: 'https://upload.wikimedia.org/wikipedia/commons/c/c4/Tupinambis_merianae_Pantanal.jpg', tier: 'B', tierLabel: 'Raro', pts: 80, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Clareiras e bordas de mata', habitat: 'Floresta/Campo', wiki: 'https://pt.wikipedia.org/wiki/Tei%C3%BA', danger: 'medio', habits: ['🥩 Onívoro', '☀️ Diurno', '🌡️ Termorregula'], howToFind: 'Clareiras e bordas de mata; pode morder se provocado' },
  { id: 'esquilo', name: 'Esquilo', sci: 'Sciurus aestuans', emoji: '🐿️', img: 'https://upload.wikimedia.org/wikipedia/commons/5/5d/Sciurus_aestuans.jpg', tier: 'B', tierLabel: 'Raro', pts: 600, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas e capoeiras', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Caxinguel%C3%AA', danger: 'inofensivo', habits: ['🥜 Granívoro', '🌳 Arborícola', '☀️ Diurno'], howToFind: 'Troncos e galhos na mata; rápido e esperto' },
  { id: 'coruja', name: 'Coruja', sci: 'Athene cunicularia', emoji: '🦉', img: 'https://upload.wikimedia.org/wikipedia/commons/e/e5/Athene_cunicularia_1_edited.JPG', tier: 'B', tierLabel: 'Raro', pts: 70, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e tocas no chão', habitat: 'Campo', wiki: 'https://pt.wikipedia.org/wiki/Coruja-buraqueira', danger: 'baixo', habits: ['🐛 Insetívora', '🌅 Crepuscular', '🕳️ Toca no chão'], howToFind: 'Campos abertos com tocas; vista durante o dia' },
  ...
  { id: 'beija-flor', name: 'Beija-flor', sci: 'Eupetomena macroura', emoji: '🌸', img: 'https://upload.wikimedia.org/wikipedia/commons/8/8e/Haeckel_Trochilidae.jpg', tier: 'B', tierLabel: 'Raro', pts: 60, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Jardins e bordas de mata', habitat: 'Floresta/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Beija-flor-tesoura', danger: 'inofensivo', habits: ['🌸 Néctar', '✈️ Voo rápido', '🗺️ Territorial'], howToFind: 'Jardins e bordas de mata com flores; voo muito rápido' },
  { id: 'trinca-ferro', name: 'Trinca-ferro', sci: 'Saltator similis', emoji: '🐦', img: 'https://upload.wikimedia.org/wikipedia/commons/8/86/Saltator_similis.jpg', tier: 'B', tierLabel: 'Raro', pts: 60, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas e capoeiras', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Trinca-ferro', danger: 'inofensivo', habits: ['🍉 Frugívoro', '🎵 Canto forte', '🌳 Arborícola'], howToFind: 'Siga o canto forte e melodioso na mata' },
  { id: 'cascavel', name: 'Cascavel', sci: 'Crotalus durissus', emoji: '🐍', img: 'https://upload.wikimedia.org/wikipedia/commons/2/2a/Crotalus_durissus.jpg', tier: 'B', tierLabel: 'Raro', pts: 110, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e cerrado', habitat: 'Cerrado/Campo', wiki: 'https://pt.wikipedia.org/wiki/Cascavel', danger: 'critico', habits: ['🥩 Carnívora', '🌙 Noturna', '🔔 Chocalho'], howToFind: 'Campos abertos e pedregosos; ouça o chocalho antes de ver' },
  ...
  // ─── TIER C (Comuns) ───
  { id: 'capivara', name: 'Capivara', sci: 'Hydrochoerus hydrochaeris', emoji: '🦫', img: 'https://upload.wikimedia.org/wikipedia/commons/3/34/Hydrochoeris_hydrochaeris_in_Brazil_in_Petr%C3%B3polis%2C_Rio_de_Janeiro%2C_Brazil_09.jpg', tier: 'C', tierLabel: 'Comum', pts: 95, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Margens de rios e lagoas', habitat: 'Brejo/Rio', wiki: 'https://pt.wikipedia.org/wiki/Capivara', danger: 'medio', habits: ['🌿 Herbívoro', '💧 Aquática', '👨‍👩‍👧‍👧 Grupos'], howToFind: 'Margens de rios e lagoas; não encurrale — pode morder' },
  { id: 'lebre', name: 'Lebre', sci: 'Sylvilagus brasiliensis', emoji: '🐰', img: 'https://upload.wikimedia.org/wikipedia/commons/7/74/Tapiti_%28Sylvilagus_brasiliensis%29.jpg', tier: 'C', tierLabel: 'Comum', pts: 75, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e bordas de mata', habitat: 'Campo/Floresta', wiki: 'https://pt.wikipedia.org/wiki/Tapiti', danger: 'inofensivo', habits: ['🌿 Herbívora', '🌅 Crepuscular', '🏃 Veloz'], howToFind: 'Campos abertos ao amanhecer e entardecer; foge rapidamente' },
  { id: 'gamba', name: 'Gambá', sci: 'Didelphis albiventris', emoji: '🦨', img: 'https://upload.wikimedia.org/wikipedia/commons/b/b7/Didelphis_albiventris%2C_Bahia%2C_Brazil.jpg', tier: 'C', tierLabel: 'Comum', pts: 70, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas urbanas e matas', habitat: 'Floresta/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Gamb%C3%A1-de-orelha-branca', danger: 'medio', habits: ['🥩 Onívoro', '🌙 Noturno', '🏘️ Urbano'], howToFind: 'Áreas urbanas e matas; noturno, evite contato' },
  ...
  { id: 'cobra-cipo', name: 'Cobra-cipó', sci: 'Chironius bicarinatus', emoji: '🐍', img: 'https://upload.wikimedia.org/wikipedia/commons/e/ed/Chironius_bicarinatus_0.jpg', tier: 'C', tierLabel: 'Comum', pts: 40, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Matas e bordas de capoeira', habitat: 'Floresta Atlântica', wiki: 'https://pt.wikipedia.org/wiki/Cobra-cip%C3%B3', danger: 'medio', habits: ['🥩 Carnívora', '☀️ Diurna', '🌳 Arborícola'], howToFind: 'Galhos e cipós na borda da mata; rápida e esguia' },
  { id: 'joao-de-barro', name: 'João-de-barro', sci: 'Furnarius rufus', emoji: '🐦', img: 'https://upload.wikimedia.org/wikipedia/commons/4/40/Rufous_Hornero_%28Furnarius_rufus%29.jpg', tier: 'C', tierLabel: 'Comum', pts: 38, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e postes', habitat: 'Campo/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Jo%C3%A3o-de-barro', danger: 'inofensivo', habits: ['🏗️ Construtor', '🧱 Ninho de barro', '☀️ Diurno'], howToFind: 'Postes e árvores isoladas; procure o ninho de barro característico' },
  { id: 'rolinha', name: 'Rolinha', sci: 'Columbina talpacoti', emoji: '🕊️', img: 'https://upload.wikimedia.org/wikipedia/commons/c/c9/Columbina_talpacoti.jpeg', tier: 'C', tierLabel: 'Comum', pts: 20, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas abertas e urbanas', habitat: 'Urbano/Campo', wiki: 'https://pt.wikipedia.org/wiki/Rolinha', danger: 'inofensivo', habits: ['🌿 Granívora', '☀️ Diurna', '🏘️ Urbana'], howToFind: 'Áreas abertas, fios e chão; pequena e rápida' },
  { id: 'sapo-cururu', name: 'Sapo', sci: 'Rhinella schneideri', emoji: '🐸', img: 'https://upload.wikimedia.org/wikipedia/commons/a/ae/Bufo_schneideri01c.jpg', tier: 'C', tierLabel: 'Comum', pts: 20, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Próximo a corpos d\'água', habitat: 'Brejo/Rio', wiki: 'https://pt.wikipedia.org/wiki/Sapo-cururu', danger: 'medio', habits: ['🐜 Insetívoro', '🌙 Noturno', '💧 Úmido'], howToFind: 'Próximo a corpos d\'água; não toque — glândulas venenosas' },
  { id: 'ra', name: 'Rã', sci: 'Leptodactylus ocellatus', emoji: '🐸', img: 'https://upload.wikimedia.org/wikipedia/commons/b/bd/Leptodactylus_labyrinthicus.jpg', tier: 'C', tierLabel: 'Comum', pts: 22, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Brejos e poças', habitat: 'Brejo/Rio', wiki: 'https://pt.wikipedia.org/wiki/R%C3%A3-manteiga', danger: 'inofensivo', habits: ['🐜 Insetívoro', '🌙 Noturno', '💧 Brejo'], howToFind: 'Brejos e poças; siga o coaxar noturno' },
  { id: 'abelha', name: 'Abelha', sci: 'Apis mellifera', emoji: '🐝', img: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Apis_mellifera_-_Brassica_napus_-_Valingu.jpg', tier: 'C', tierLabel: 'Comum', pts: 18, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Jardins e campos floridos', habitat: 'Campo/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Abelha-europeia', danger: 'medio', habits: ['🌸 Polinizadora', '🍯 Produtora de mel', '👷‍♀️ Colmeia'], howToFind: 'Jardins e campos floridos; não perturbe a colmeia' },
  { id: 'camundongo', name: 'Camundongo-do-mato', sci: 'Oligoryzomys nigripes', emoji: '🐀', img: 'https://upload.wikimedia.org/wikipedia/commons/8/82/Ejemplar_de_colilargo_grande_%28Oligoryzomys_nigripes%29%2C_Uruguay%2C_2022.jpg', tier: 'C', tierLabel: 'Comum', pts: 15, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Chão da mata e roças', habitat: 'Floresta/Campo', wiki: 'https://pt.wikipedia.org/wiki/Rato-do-mato', danger: 'inofensivo', habits: ['🌿 Herbívoro', '🌙 Noturno', '🌳 Solo'], howToFind: 'Chão da mata; pequeno e rápido' },
  { id: 'canario-da-terra', name: 'Canarinho-da-terra', sci: 'Sicalis flaveola', emoji: '🐦', tier: 'C', tierLabel: 'Comum', pts: 15, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Campos abertos e áreas rurais', habitat: 'Campo/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Can%C3%A1rio-da-terra', danger: 'inofensivo', habits: ['🌿 Granívoro', '🎵 Canto melodioso', '☀️ Diurno'], howToFind: 'Campos abertos e áreas rurais; siga o canto' },
  ...
  { id: 'borboleta', name: 'Borboleta', sci: 'Danaus plexippus', emoji: '🦋', img: 'https://upload.wikimedia.org/wikipedia/commons/7/73/Monarch_Butterfly_Danaus_plexippus_Male_2664px.jpg', tier: 'D', tierLabel: 'Muito Comum', pts: 10, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Jardins e campos', habitat: 'Campo/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Borboleta-monarca', danger: 'inofensivo', habits: ['🌸 Néctar', '☀️ Diurna', '🗺️ Migratória'], howToFind: 'Jardins floridos durante o dia' },
  ...
  { id: 'mosquito', name: 'Mosquito-pernilongo', sci: 'Culex quinquefasciatus', emoji: '🦟', img: 'https://upload.wikimedia.org/wikipedia/commons/d/d7/CulexNil.jpg', tier: 'D', tierLabel: 'Muito Comum', pts: 10, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas úmidas e urbanas', habitat: 'Urbano/Brejo', wiki: 'https://pt.wikipedia.org/wiki/Culex_quinquefasciatus', danger: 'medio', habits: ['🩸 Hematófago', '🌙 Noturno', '💧 Água parada'], howToFind: 'Áreas úmidas ao anoitecer; mais ativo à noite' },
  { id: 'mariposa', name: 'Mariposa', sci: 'Ascalapha odorata', emoji: '🦋', img: 'https://upload.wikimedia.org/wikipedia/commons/b/bf/DruryV1P003AA.jpg', tier: 'D', tierLabel: 'Muito Comum', pts: 6, status: 'LC', statusLabel: 'Pouco preocupante', where: 'Áreas abertas e urbanas', habitat: 'Floresta/Urbano', wiki: 'https://pt.wikipedia.org/wiki/Bruxa_(mariposa)', danger: 'inofensivo', habits: ['🌙 Noturna', '💡 Atrai luz', '🦋 Voo noturno'], howToFind: 'Próximo a luzes à noite; a maior mariposa do Brasil' },
]
