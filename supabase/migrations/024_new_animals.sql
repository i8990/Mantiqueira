...
VALUES
  ...
  ('japu', 'Japu', 'Psarocolius decumanus', '🐦', 'B', 'Raro', 100, 'LC', 'Pouco preocupante', 'Matas altas, bordas de floresta e árvores isoladas com copa', 'Floresta Atlântica', 'https://pt.wikipedia.org/wiki/Japu');
